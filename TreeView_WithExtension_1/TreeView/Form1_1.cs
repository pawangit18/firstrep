...
namespace TreeView
{
    public partial class Form1_New : Form
    {
       ...
       //  string Version;
        ...
        {
            //this.Parent.MaximumSize = new Size(140, 480);
            //this.Parent.MaximumSize.Height = 500;
            //this.Parent.Refresh();
            //this.Text = "FHIR Version-" + Version;
            SetFormText();
                ...
                case "3.0.1":
                    {
                        ...
                        xDocSingleFhirSchema = XDocument.Load(assembly.GetManifestResourceStream(fileName));
                        XElement ele =
           ...
           // 
           /*
           xDocSingleFhirSchema = XDocument.Load(@"C:\Backup t450\MyData\Projects\TreeView\TreeView\fhir-v4_0_1\fhir-single.xsd");
            XElement ele =
                      xDocSingleFhirSchema.Descendants(ns + "complexType")
                      .Where(x => x.Attribute("name").Value.Equals("ResourceContainer")    //x.Name.LocalName.Equals("Activity") &&
                      ).FirstOrDefault();
        ...
        {
            //ContextMenu menu = new ContextMenu(new MenuItem { Name = "Property" });
